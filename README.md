...
export SRVDOKOPP_CERT_PASSWORD=<certpw>
```
...
VM Options: `-Dsrvdokopp_cert_keystore=/path/til/cert.jks -Dsrvdokopp_cert_password=<certpw> -Djavax.net.ssl.trustStore=/path/til/truststore.jks -Djavax.net.ssl.trustStorePassword=<truststorepw>`
