...
public class ServiceOrchestrator {
	...
	@Handler
	private void orchestrate(@ExchangeProperty(PROPERTY_JOURNALPOST_ID) String journalpostId, no.nav.opprettoppgave.tjenestespesifikasjon.v1.xml.jaxb2.gen.OpprettOppgave opprettOppgave) {
